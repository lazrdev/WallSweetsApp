...
open class WallpapersDataViewModel(application: Application) : AndroidViewModel(application) {
    ...
    private suspend fun loadRemoteData(
        ...
        try {
            val remoteWallpapers = service.getJSON("https://raw.githubusercontent.com/lazrdev/wallsweetswalls/main/walls.json")
    ...
    fun loadData(
        ...
        viewModelScope.launch {
            ...
            loadRemoteData("https://raw.githubusercontent.com/lazrdev/wallsweetswalls/main/walls.json", loadCollections, loadFavorites, force, triggerErrorListener)
        }
    }
